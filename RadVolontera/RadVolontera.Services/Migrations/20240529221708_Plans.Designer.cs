...
namespace RadVolontera.Services.Migrations
{
    ...
    [Migration("20240529221708_Plans")]
    partial class Plans
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RadVolontera.Services.Database.MonthlyPlanTemplate", b =>
                {
                    ...
                    b.Property<int>("AnnualPlanTemplateId")
                        .HasColumnType("int");

                    b.Property<long>("AnnualPlanTemplateId1")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("AnnualPlanTemplateId1");

                    b.ToTable("MonthlyPlanTemplate");
                });
            ...
            modelBuilder.Entity("RadVolontera.Services.Database.MonthlyPlanTemplate", b =>
                {
                    b.HasOne("RadVolontera.Services.Database.AnnualPlanTemplate", "AnnualPlanTemplate")
                        ...
                        .HasForeignKey("AnnualPlanTemplateId1")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
