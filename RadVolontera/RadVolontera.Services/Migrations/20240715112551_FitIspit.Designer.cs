...
namespace RadVolontera.Services.Migrations
{
    ...
    [Migration("20240715112551_FitIspit")]
    partial class FitIspit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CompanyEventUser", b =>
                {
                    ...
                    b.HasKey("CompanyEventsId", "MentorsId");

                    b.HasIndex("MentorsId");

                    b.ToTable("CompanyEventUser");
                });
            ...
            modelBuilder.Entity("RadVolontera.Services.Database.FITPasos", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CompanyEventUser", b =>
                {
                    b.HasOne("RadVolontera.Services.Database.CompanyEvent", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RadVolontera.Services.Database.FITPasos", b =>
                {
                    b.HasOne("RadVolontera.Services.Database.User", "User")
                        .WithMany("FITPasos")
